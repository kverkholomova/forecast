                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[1]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[2]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[3]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[4]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[5]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[6]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[7]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
                ...
                FutureBuilder<Weather5Days>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      var tom =
                          "${snapshot.data!
                          .commonList?[8]["weather"][0]["description"]}";
                      return Text(
                        tom,
                        style: GoogleFonts.roboto(
                          fontSize: 12,
